...
namespace TFI.OCM.AziendaConsulente
{
    public class DelegheOCM
    {
        ...
        {
            public string PosizioneAz { get; set; }

            public string CodUteAz { get; set; }

            public string RagSocAz { get; set; }

            public string RagSocBrAz { get; set; }

            public string ParIvaAz { get; set; }

            public string CodFisAz { get; set; }

            public string IndAz { get; set; }

            public string CittaAz { get; set; }

            public string PrAz { get; set; }

            public string CapAz { get; set; }

            public string StatoEstAz { get; set; }

            public string TelAz { get; set; }

            public string FaxAz { get; set; }

            public string EmailAz { get; set; }

            public string EmailCertAz { get; set; }

            public string NATGIU { get; set; }

            public string NumCivAz { get; set; }

            public string CodIndAz { get; set; }
            ...
            public string OtpDeleghe { get; set; }
            public string datini { get; set; }
            public bool IsCancellata { get; set; }
            public bool IsInAttesa { get; set; }
